...
CSV.foreach(csv_file, headers: true) do |row|
  ...
  next if algoritmo == 'Bubble Sort'
  tempos[algoritmo] ||= []
  tempos[algoritmo] << [tamanho, tempo]
end

g = Gruff::Line.new
g.title = 'Comparativo de Desempenho dos Algoritmos de Ordenação (Sem Bubble Sort)'
...
g.write('./grafico_comparativo_sem_bubble_sort.png')
